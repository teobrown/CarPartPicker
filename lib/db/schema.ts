...
export const vehicles = pgTable(
  'vehicles',
  {
    ...
    centerBoreMm: real('center_bore_mm'),
    stockWheelWidthIn: real('stock_wheel_width_in'),
    stockWheelOffsetMm: integer('stock_wheel_offset_mm'),
    stockTireSize: varchar('stock_tire_size', { length: 32 }),
    maxNoRubWidthIn: real('max_no_rub_width_in'),
  },
  (t) => ({
